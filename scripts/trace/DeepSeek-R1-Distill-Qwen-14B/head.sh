python3 run.py extract_prober_weights \
    ...
    --save_path outputs/refusal/DeepSeek-R1-Distill-Qwen-14B/refusal_vector.pt
...
CUDA_VISIBLE_DEVICES=0 python3 run.py find_refusal_head \
    ...
    --batch_size 1 \
    --truncate_num 1000 \
    --save_path outputs/refusal/DeepSeek-R1-Distill-Qwen-14B/refusal_suppression_heads.json \
    --refusal_direction_path outputs/refusal/DeepSeek-R1-Distill-Qwen-14B/refusal_vector.pt \
    --layer_idx 48 \
    --thinking_portion 0 \
