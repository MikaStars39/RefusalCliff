python3 run.py api_inference \
    --json_file="outputs/refusal/DeepSeek-R1-Distill-Qwen-14B/ultrachat.json" \
...
python3 run.py api_inference \
    --json_file="outputs/refusal/DeepSeek-R1-Distill-Qwen-14B/advbench.json" \
...
python3 run.py api_inference \
    --json_file="outputs/refusal/DeepSeek-R1-Distill-Qwen-14B/jbbench.json" \
