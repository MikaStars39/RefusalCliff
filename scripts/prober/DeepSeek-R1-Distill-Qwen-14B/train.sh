python3 run.py collect_non_refusal \
    --json_path outputs/refusal/DeepSeek-R1-Distill-Qwen-14B/ultrachat.json \
    --save_path outputs/refusal/DeepSeek-R1-Distill-Qwen-14B/no_refusal.json
...
python3 run.py train_prober \
    ...
    --jbb_path outputs/refusal/DeepSeek-R1-Distill-Qwen-14B/refusal.pt \
    --epochs 5 \
    --save_path outputs/refusal/DeepSeek-R1-Distill-Qwen-14B/linear_prober.pt
