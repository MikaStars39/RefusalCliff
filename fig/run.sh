...
python3 fig/draw_attention_heatmap.py plot \
   --data_path="outputs/refusal/DeepSeek-R1-Distill-Qwen-7B/refusal_suppression_heads.json" \
   --value_key="cosine_similarity" \
   --title="R1-Distill-Qwen-7B" \
   --save_path="outputs/fig/R1-Distill-Qwen-7B_refusal_heatmap.png" \
   --width 3.8 \
   --height 3
